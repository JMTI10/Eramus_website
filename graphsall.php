    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ['class Name','olhao',],['class Name','huittinen',],
                <?php 											
							$query = "SELECT * from sensors_readings where id_sensor = 1 and (id_location = 1 and id_location = 3)";						
							...
							echo "['".$row['reading_date'].'@'.$row['reading_hour']."',".$row['value']."],";
							 }
						?>
            ]);
            //LineChart
			...
			var x = document.getElementById("day2");
            x.setDate($_GET[day])
        ...
        function drawChart1() {
            var data1 = google.visualization.arrayToDataTable([
                ['class Name', 'olhao'],
                <?php 
						$query = "SELECT * from sensors_readings where id_sensor = 2";
							if(isset($_GET["day"]) && !empty($_GET["day"])){
        ...
        function drawChart2() {
            var data2 = google.visualization.arrayToDataTable([
                ['class Name', 'olhao'],
                <?php 
						$query = "SELECT * from sensors_readings where id_sensor = 3";
							if(isset($_GET["day"]) && !empty($_GET["day"])){
								$query = $query . " and between reading_date='$_GET[day] and reading_date='$_GET[day2] order by reading_date, reading_hour'";
								$_GET[day] = $_SET[day];
							}else{
                            ...
                            <div class="col-md-6"">
							   <div class="mb-3">
                                ...
                                <form action="graphs.php" class="form-inline">                                    										
                                            <input id="date" type="date" name="day" class="form-control">
											<input id="date2" type="date" name="day2" class="form-control" value="<?php echo $_GET[day2]; ?>">
